export const zhTw = {
  ...
  Setup: {
    title: "初始設置",
    description: "請提供啟動應用程序所需的配置。",
    rpcUrl: "區塊鏈 RPC URL",
    privateKey: "私鑰",
    domain: "您的域名",
    alchemySigningKey: "Alchemy 簽名密鑰",
    alchemyAuthToken: "Alchemy 認證令牌",
    generateWallet: "生成錢包",
    walletAddress: "錢包地址",
    privateKeyHidden: "私鑰 (已生成)",
    saveButton: "下一步",
    saving: "處理中...",
    deployTitle: "部署合約",
    deployDescription: "為您的錢包充值並部署必要的智能合約。",
    currentBalance: "當前餘額",
    fundWallet: "充值錢包",
    scanQrCode: "掃描充值",
    deploy: "部署",
    ...
    address: "地址",
    finishSetup: "完成設置",
    successMessage: "配置已保存！正在前往部署。",
    finalSuccessMessage: "設置完成！請重啟應用程序。",
    errorMessage: "無法保存配置。",
    ok: "好",
    cancel: "取消",
    confirm: "確認",
