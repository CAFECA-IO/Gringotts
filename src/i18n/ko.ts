export const ko = {
  ...
  Setup: {
    title: "초기 설정",
    description: "애플리케이션을 시작하는 데 필요한 구성을 제공하십시오.",
    rpcUrl: "블록체인 RPC URL",
    privateKey: "개인 키",
    domain: "도메인",
    alchemySigningKey: "Alchemy 서명 키",
    alchemyAuthToken: "Alchemy 인증 토큰",
    generateWallet: "지갑 생성",
    walletAddress: "지갑 주소",
    privateKeyHidden: "개인 키 (생성됨)",
    saveButton: "다음 단계",
    saving: "처리 중...",
    deployTitle: "계약 배포",
    deployDescription: "지갑에 자금을 입금하고 필요한 스마트 계약을 배포하십시오.",
    ...
    address: "주소",
    finishSetup: "설정 완료",
    successMessage: "구성이 저장되었습니다! 배포로 진행합니다.",
    finalSuccessMessage: "설정 완료! 애플리케이션을 다시 시작하십시오.",
    errorMessage: "구성을 저장하지 못했습니다.",
    ok: "확인",
    cancel: "취소",
    confirm: "확인",
    close: "닫기",
